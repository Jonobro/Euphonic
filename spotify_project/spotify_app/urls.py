...
urlpatterns = [
    ...
    path('stream_initial_analysis/', views.stream_initial_analysis, name='stream_initial_analysis'),
    ...
    path('get_submitted_playlists/', views.get_submitted_playlists_api, name='get_submitted_playlists')
]