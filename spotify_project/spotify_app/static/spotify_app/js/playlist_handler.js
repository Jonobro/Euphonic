            ...
            if (trackLinks.length > 0) {
                ...
                openButton.addEventListener('click', async () => {
                    ...
                    try {
                        ...
                        console.error('Error opening playlist');
                        if (window.addEphemeralMessage) {
                            window.addEphemeralMessage("Sorry, there was an error opening the playlist. Please try again.", 'ai');
                        } else {
