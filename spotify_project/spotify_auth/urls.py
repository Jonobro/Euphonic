...
urlpatterns = [
    ...
    path('chat/existing/', views.existing_song_chat_view, name='existing_song_chat'),
    ...
    path('initialize_music_analysis_data_view/', views.initialize_music_analysis_data_view, name='initialize_music_analysis_data_view'),
